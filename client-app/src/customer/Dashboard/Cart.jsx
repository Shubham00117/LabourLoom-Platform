  ...
  const displayRazorPay = async (amount) => {
    try {
      ...
      const options = {
        ...
        currency: "INR",
        amount: amount * 100,
        name: "labourloom platform",
        description: "Congratulations",
        handler: function (response) {
          alert("Payment successful");

          axios.patch(`http://localhost:8080/order/update-transaction`, {
            orderId: Order.id,
  ...
  return (
    <div className="center">
      <div className="h-screen bg-gray-100 pt-20 justify-between">
        <h1 className="mb-2 flex justify-between font-bold text-2xl">
          Service Information
        </h1>
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            ...
            <div className="mb-2 flex justify-between">
              ...
              <p className="text-gray-700">
                {store.getState().user.value.firstName}
              </p>
            </div>
            <hr className="my-4" />
            <div className="flex justify-between">
              ...
              <div>
                <p className="mb-1 font-bold text-lg">500 Rs</p>
              </div>
            </div>
            <button
